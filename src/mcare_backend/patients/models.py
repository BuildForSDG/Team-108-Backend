...
class Messages(models.Model):
    author = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET(get_custom_user), null=True, blank=True)
    message = models.TextField(null=True, blank=True)
    receiver_expert = models.ForeignKey(
        'PatientProfile', related_name="receiver_expert", on_delete=models.SET(get_custom_user),  null=True, blank=True)
...
#     members = models.ForeignKey('PatientProfile', on_delete=models.SET(get_custom_user))
#     group = models.ForeignKey('PatientGroup',on_delete=models.SET(get_custom_user))